...
def input_spec():
    ...
    return [position, forward_direction, target_position, cell_view, in_range, actual_potion, agent_actual_HP,
            target_actual_HP]
...
def network_spec(states, baseline=False):
    ...
    global_state = tf.concat([states[0], states[1], states[2], states[4], states[5], states[6], states[7]], axis=1)
